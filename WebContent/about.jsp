...
<!-- Basic Page Needs
  ================================================== -->
<meta charset="utf-8">
<title>About - Online Store Matters</title>
...
<body>
	...
	<section class="page-title-alt bg-primary position-relative">
		...
		<img src="images/illustrations/leaf-bg-top.png" alt="illustrations"
			...
			src="images/illustrations/dots-group-sm.png" alt="illustrations"
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<p>Deserunt mollit anim id est laborum. Sed ut perspiciatis
